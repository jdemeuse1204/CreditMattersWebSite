...
export class TransUnionGrid {
    ...
    load() {
            ...
            gridInitComplete: function () {
                ...
                const getId = (e) => {
                    ...
                    onRightAction = function (e) {
                        management.changeCreditItemResponse(constants.creditBureaus.transUnion, constants.creditBureauStatuses.positive, getId(e)).then(() => {
                            that.load();
                        });
                    },
                    onLeftAction = function (e) {
                        management.changeCreditItemResponse(constants.creditBureaus.transUnion, constants.creditBureauStatuses.deleted, getId(e)).then(() => {
                            that.load();
                        });
                    },
                    onTap = function (e) {
                        ...
                        that.gridServices.openModal(id, constants.creditBureaus.transUnion).then(response => {
                ...
                swipable("#manage-credit-items-transunion-table_wrapper .cm-swipable",
                    onRightAction,
                    onLeftAction,
                    onTap);

                //#region Desktop
                $("#manage-credit-items-transunion-table_wrapper a[data-action=\"edit\"]").unbind("click");
                $("#manage-credit-items-transunion-table_wrapper a[data-action=\"edit\"]").click(function (e) {
        ...
        return new Promise((resolve, reject) => {
            ...
            let mobileTemplate = kendo.template(getTemplateHtml("#mobile-credit-item-transunion"));

            if (that.table) {

                if ($("#manage-credit-items-transunion-table_wrapper").length === 0) {
                    that.table.destroy();
                    $("#manage-credit-items-transunion-table").removeData();
                    $("#manage-credit-items-transunion-table").empty();
                } else {
                    management.getCreditItems(constants.creditBureaus.transUnion).then(function (refreshResponse) {
            ...
            management.getCreditItems(constants.creditBureaus.transUnion).then(function (initResponse) {

                that.data = initResponse.Data.result;

                that.table = $("#manage-credit-items-transunion-table").DataTable({
                    data: that.data,
                    columns: [
                        {
                            title: "",
                            ...
                            render: function (e) {
                                ...
                                return getTemplate("#desktop-manage-credit-items-actions-transunion", model);
                            }
                        },
                        ...
                        },
                        {
                            ...
                            render: function (e) {
                                ...
                                const item = _.find(that.data, function (i) { return i.Id === e; }),
                                    deleted = item.TransUnionResponseStatusId === 4,
                                    positive = item.TransUnionResponseStatusId === 3;
                ...
                // modify table
                const items = $("#manage-credit-items-transunion-table_wrapper > div.row .col-sm-6");
