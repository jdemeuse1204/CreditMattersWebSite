...
export class AddNewCreditItemModal {
  ...
  disputeReasonChange(event) {
    let reason = find(this.disputeReasons, {
      Id: this.model.creditItem.DisputeReasonId
    });
  ...
  save() {
    ...
    if (this.isUsingCustomReason === true) {
      ...
      validateOptions = [{
          object: this.model.creditItem,
          rules: coreRules
        },
        {
          object: this.model.creditItem.Creditor,
          rules: creditItemRule
        },
        {
          object: this,
          rules: customRules
