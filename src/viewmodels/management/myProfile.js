...
export class MyProfile {
  ...
  openPhoneNumbersModal() {
    const that = this;
    const homePhoneNumber = find(this.userInformationItems, {
      type: constants.phoneNumberTypes.home
    });
    const workPhoneNumber = find(this.userInformationItems, {
      type: constants.phoneNumberTypes.work
    });
    const mobilePhoneNumber = find(this.userInformationItems, {
